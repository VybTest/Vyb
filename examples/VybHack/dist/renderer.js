 ...
 */
function render(game, fogMap, floor = 1, ladder = null) {
    // Clear screen
    ...
    console.log("━".repeat(game.width + 2));
    // Render player stats
    console.log(`${COLOR_PLAYER}@ Player${RESET_COLOR} | HP: ${game.player.hp}/${game.player.maxHP} | ATK: ${game.player.attack} | DEF: ${game.player.defense}`);
